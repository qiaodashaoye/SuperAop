...
public class RetryAspect {
    ...
    private static final String POINTCUT_METHOD = "execution(@com.qpg.aop.trace.RetryTrace * *(..))";
    ...
    public Object doRetryMethod(final ProceedingJoinPoint joinPoint, RetryTrace retry) throws Throwable {
